      ...
      <div className="min-h-screen">
        ...
        <section className="py-20 px-4 md:px-16 lg:px-20">
          <div className="flex flex-col lg:flex-row justify-center items-center gap-8 lg:gap-8">
            ...
            <div className="relative flex-shrink-0">
              ...
              <div className="absolute right-16 top-16 w-37 h-35 bg-wastex-icon-bg rounded-2xl mix-blend-multiply"></div>
              <img
        ...
        <section className="py-12 px-4 md:px-16 lg:px-36 bg-gray-100">
          <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            <div className="relative flex-shrink-0">
              {/* Yellow decorative square */}
              <div className="absolute -left-4 -top-4 w-26 h-26 bg-wastex-icon-bg rounded-2xl mix-blend-multiply"></div>
              <div className="relative flex justify-end items-center bg-wastex-dark-bg rounded-2xl p-6">
                <img
