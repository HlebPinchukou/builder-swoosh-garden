            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 mb-4">
              ...
              <div className="bg-wastex-card-bg rounded-lg p-4 flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-2">
                  <h3 className="text-wastex-hero-text text-xl font-bold tracking-wider">
                    PLASTICS
                  </h3>
              ...
              <div className="bg-wastex-card-bg rounded-lg p-4 flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <p className="text-wastex-hero-text text-base leading-relaxed tracking-wide">
                    Consists of batteries, computers, phones and other
                    electronic waste.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-wastex-card-bg rounded-lg p-4 flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <p className="text-wastex-hero-text text-base leading-relaxed tracking-wide">
                    Covers large items such as stoves, AC units, refrigerators,
                    freezers, TVs, beds, mattresses, sofas, and tables.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-wastex-card-bg rounded-lg p-4 flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <p className="text-wastex-hero-text text-base leading-relaxed tracking-wide">
                    Includes organic waste such as food scraps, garden waste,
